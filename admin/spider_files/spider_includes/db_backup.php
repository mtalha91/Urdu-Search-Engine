...
$stats  = mysql_query("SHOW TABLE STATUS FROM $database_name");
...
else
{
   ...
   chmod($backup_path, 0777);
	...
	$fp = gzopen ($backup_path.$filename,"w");
        $copyr="# Table backup from Urdu Search Engine\n".
...
if (!preg_match("#/restore\.#i",$_SERVER['PHP_SELF'])) 
{
	...
	{ 
	   ...
	   gzwrite ($fp,"# Valid end of backup from Urdu Search Engine backup\n");
     gzclose ($fp);
}
}
