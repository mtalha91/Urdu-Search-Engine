 ...
 function confirm_rest_prompt(URL) {
	...
	window.location = URL;
            ...
            <div class="grid_12">
                ...
                <div class="module">
				<h2><span>Showing Tables from URDU Search Engine Database</span></h2>
...
<input type="hidden" name="page_value" value="database">
...
<center><input  class='input-short' id='submit' type='submit' name='send2' value='Optimize'></center><br>
...
<table>
 <tr>
	...
	<input  id='submit'"; if (!get_extension_funcs('zlib'))echo 'disabled'; echo " type='submit' name='send2'class='input-short' value='Backup'>
	</td>
 </tr>
 <tr>
	<td>
	...
	{ 
		if ($file != "." && $file != ".." &&  (preg_match("#\.sql#i",$file) || preg_match("#\.gz#i",$file))){
			...
			echo "<tr><td nowrap class=$bgcolor align=\"center\">$file</td>
				 ...
				 <td nowrap class=$bgcolor align=\"left\"><input class='input-short' type='button' id='submit' onclick=\"confirm_rest_prompt('./admin.php?page_value=database&file=$file&del=0');\" value='Restore'> &nbsp;<input class='input-short'type='button' id='submit' onclick=\"confirm_del_prompt('./admin.php?page_value=database&file=$file&del=1');\" value='Delete'></td>
				 </tr>"; 
